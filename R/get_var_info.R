#' Get information regarding SenateData variables
#'
#' \code{get_var_info} retrieves information regarding variables in the SenteData dataset.
...
#' @import dplyr
#' 
#' @return A tibble with information about variables in the SenateData dataset.
...
get_var_info <- function(var_names = NULL, related_to = NULL){
  ...
  # get codebook
  # cb_temp <- tempfile()
  # cb_url  <- "https://ippsr.msu.edu/senatecodebook"
