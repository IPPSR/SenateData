...
\name{get_var_info}
\alias{get_var_info}
\title{Get information regarding SenateData variables}
\usage{
...
\value{
  A tibble with information about variables in the SenateData dataset.
...
\description{
  \code{get_var_info} retrieves information regarding variables in the SenateData dataset.
